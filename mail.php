...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	try {
		...
		$headers .= "From: \"Rimmer for Congress 2020\" <info@rimmerforcongress.com>\r\n";
		$headers .= "Reply-To: info@rimmerforcongress.com";

		// Send the mail
		if ( mail("info@rimmerforcongress.com", $subject, $body, $headers) ) {
			echo "1";
		}
	}
	catch (Exception $e) {
